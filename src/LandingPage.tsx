...
import { Brain, ChevronRight, Code, Cpu, Globe, LineChart, Rocket, Users, Menu, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react'
import {
  Sheet,
  SheetContent,
  SheetHeader,
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="fundamentals" className="w-full">
            <TabsList className="grid w-full grid-cols-1 md:grid-cols-4 mb-32 md:mb-2 xl:mb-0 gap-3 bg-muted/50">
